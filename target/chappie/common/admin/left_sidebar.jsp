...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<!-- Nav Item - Charts -->
	<li class="nav-item"><a class="nav-link" href="admin-home?action=view-products"> <i class="fas fa-fw fa-table"></i> <span>Quản lý sản phẩm</span></a></li>

	<!-- Nav Item - Tables -->
	<li class="nav-item"><a class="nav-link" href="admin-home?action=view-accounts"> <i class="fas fa-fw fa-table"></i> <span>Quản lý tài khoản</span></a></li>
	...
	<div class="sidebar-card d-none d-lg-flex">
		...
		<a class="btn btn-success btn-sm" href="trang-chu">Trở về Web Homepage.</a>
	</div>
