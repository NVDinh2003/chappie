								...
								<c:forEach items="${model.listResult }" var="item">
									<tr>
										...
										<td><c:url var="editURL" value="/admin-news">
											...
											</c:url> <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip" title="Cập nhật bài viết" href='${editURL}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a></td>
									</tr>
								</c:forEach>
							</c:if>
							<c:if test="${check == 1 }">
