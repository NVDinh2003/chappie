			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="shop-menu pull-right">
						<ul class="nav navbar-nav">
							<li><a href="cart?action=shopping-cart"><i class="fa fa-shopping-cart"></i> Cart</a></li>
						...
						<ul class="nav navbar-nav collapse navbar-collapse">
							...
							<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
								<ul role="menu" class="sub-menu">
									<li><a href="products?action=list-products">Products</a></li>
									<li><a href="cart?action=shopping-cart">Cart</a></li>
